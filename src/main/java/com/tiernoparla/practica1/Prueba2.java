...
public class Prueba2 {
    public static void main(String[] args){
        ...
        // call getHammingCode() method and store its return value 
        //to the hammingCode array
        ...
        // The added parity bits are the difference b/w the original data 
        //and the returned hammingCode
        System.out.println("For detecting error at the reciever end, enter "
                + "position of a bit to alter original data " 
                + "(0 for no error):");  
        ...
        if(errorPosition != 0) {  
            ...
            hammingCode[errorPosition - 1] = (hammingCode[errorPosition - 1] 
                    + 1) % 2;  
        }// if 
        ...
        // create getHammingCode() method that returns the hamming code 
        //for the data which we want to send
    static int[] getHammingCode(int data[]) {
        ...
        // the size of the returnData is equal to the size of the original data 
        //+ the number of parity bits.
        returnData = new int[size + parityBits];
        
        // for indicating an unset value in parity bit location, we initialize 
        //returnData array with '2'
        ...
        for(i = 0; i < parityBits; i++) {  
            ...
            returnData[((int) Math.pow(2, i)) 
                    - 1] = getParityBit(returnData, i);  
        }// for  
          
        return returnData;  
    }// getHammingCode
    
        // create getParityBit() method that return parity bit 
        //based on the power
    ...
    static void receiveData(int data[], int parityBits) {
        ...
        // declare variable pow, which we use to get the correct bits 
        //to check for parity.
        ...
        // we use errorLoc string for storing the integer value 
        ...
        //and then correct it.  
        // errorLoc provides parity check eq. values which we use 
        //to check whether a single bit error is there or not  
